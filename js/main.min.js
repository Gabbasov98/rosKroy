...
$(".delivery-item__show").click(function() {
    if(window.innerWidth>576){
        return
    }
    $(this).parents(".delivery-item").toggleClass("_open")
    $(this).siblings(".delivery-item__hidden").slideToggle()
})
...
$(".info-nav__show .m-icon").html(
    $(".info-nav__item._active .m-icon").html()
)
$(".info-nav__show .body-l").html(
    $(".info-nav__item._active .body-l").html()
)

$(".info-nav__show").click(function () {
    $(".info-nav").toggleClass("_open")
})
